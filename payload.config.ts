            ...
            fields: [
                {
                    ...
                    required: true,
                    admin: {
                        placeholder: 'e.g., AUTOMATION, FRONTEND, BACKEND',
                        description: 'Category title (uppercase recommended)',
                    },
                },
                {
                    name: 'description',
                    ...
                    required: true,
                    admin: {
                        placeholder: 'e.g., The engines that power efficiency.',
                    ...
                    fields: [
                        {
                            ...
                            required: true,
                            admin: {
                                placeholder: 'e.g., React, n8n, PostgreSQL',
                            },
                        },
                        {
                            name: 'icon',
                        ...
                        },
                        {
                            ...
                            required: true,
                            admin: {
                                placeholder: 'e.g., UI Library, Workflow Automation',
